...
/**
 * <p>Java class for QueryCustomerArrearsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryCustomerArrearsResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="queryCustomerArrearsResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/esb/arservices}QueryCustomerArrearsRespType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "QueryCustomerArrearsResponse", propOrder = {
    "controlData",
    "detailResponse",
    "queryCustomerArrearsResponse"
})
public class QueryCustomerArrearsResponse {

    @XmlElement(required = true)
    protected ControlDataResponseHeaderType controlData;
    @XmlElement(required = true)
    protected DetailResponseType detailResponse;
    protected QueryCustomerArrearsRespType queryCustomerArrearsResponse;
    ...
    /**
     * Gets the value of the queryCustomerArrearsResponse property.
     * 
     * @return
     *     possible object is
     *     {@link QueryCustomerArrearsRespType }
     *     
     */
    public QueryCustomerArrearsRespType getQueryCustomerArrearsResponse() {
        return queryCustomerArrearsResponse;
    }

    /**
     * Sets the value of the queryCustomerArrearsResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryCustomerArrearsRespType }
     *     
     */
    public void setQueryCustomerArrearsResponse(QueryCustomerArrearsRespType value) {
        this.queryCustomerArrearsResponse = value;
    }
