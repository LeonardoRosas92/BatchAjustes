...
/**
 * <p>Java class for QueryTransferLogResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryTransferLogResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="queryTransferLogResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/esb/arservices}QueryTransferLogRespType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "QueryTransferLogResponse", propOrder = {
    "controlData",
    "detailResponse",
    "queryTransferLogResponse"
})
public class QueryTransferLogResponse {

    @XmlElement(required = true)
    protected ControlDataResponseHeaderType controlData;
    @XmlElement(required = true)
    protected DetailResponseType detailResponse;
    protected QueryTransferLogRespType queryTransferLogResponse;
    ...
    /**
     * Gets the value of the queryTransferLogResponse property.
     * 
     * @return
     *     possible object is
     *     {@link QueryTransferLogRespType }
     *     
     */
    public QueryTransferLogRespType getQueryTransferLogResponse() {
        return queryTransferLogResponse;
    }

    /**
     * Sets the value of the queryTransferLogResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryTransferLogRespType }
     *     
     */
    public void setQueryTransferLogResponse(QueryTransferLogRespType value) {
        this.queryTransferLogResponse = value;
    }
