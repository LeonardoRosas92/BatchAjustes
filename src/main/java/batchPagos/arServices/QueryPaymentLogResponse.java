...
/**
 * <p>Java class for QueryPaymentLogResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QueryPaymentLogResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="queryPaymentLogResponse" type="{http://www.amx.com.mx/mexico/telcel/di/sds/bes/esb/arservices}QueryPaymentLogRespType" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "QueryPaymentLogResponse", propOrder = {
    "controlData",
    "detailResponse",
    "queryPaymentLogResponse"
})
public class QueryPaymentLogResponse {

    @XmlElement(required = true)
    protected ControlDataResponseHeaderType controlData;
    @XmlElement(required = true)
    protected DetailResponseType detailResponse;
    protected QueryPaymentLogRespType queryPaymentLogResponse;
    ...
    /**
     * Gets the value of the queryPaymentLogResponse property.
     * 
     * @return
     *     possible object is
     *     {@link QueryPaymentLogRespType }
     *     
     */
    public QueryPaymentLogRespType getQueryPaymentLogResponse() {
        return queryPaymentLogResponse;
    }

    /**
     * Sets the value of the queryPaymentLogResponse property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryPaymentLogRespType }
     *     
     */
    public void setQueryPaymentLogResponse(QueryPaymentLogRespType value) {
        this.queryPaymentLogResponse = value;
    }
